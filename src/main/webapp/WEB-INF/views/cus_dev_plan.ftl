...
<table id="dg"  class="easyui-datagrid"
    ...
    <tr>
        ...
        <th field="devResult" width="200" align="center" formatter="forDevRes">客户开发状态</th>
...
<div id="tb">
    ...
    <a href="javascript:querySaleChanceByParams()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
</div>
